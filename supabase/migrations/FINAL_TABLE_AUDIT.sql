...
SELECT tsa.*, t.number as table_number, u.email as changed_by_email, o.order_number
...
SELECT 'EXITO: Tabla de auditoria creada con constraints explícitos' as resultado;
